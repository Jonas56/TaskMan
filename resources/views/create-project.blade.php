    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 rounded-xl p-6 ">
           <h1 class="text-center font-bold text-xl">Create new project</h1>
            <form action="/create-project" method="POST" class="mt-10">
                @csrf
                <div class="mb-6">
                    <label for="name" class="bloock mb-2 upercase font-bold text-xs text-gray-700 text-lg">Project title</label>
                    <input type="text" name="name" id="name" class="border border-gray-400 p-2 w-full mt-1">
                </div>
                <div class="mb-6">
